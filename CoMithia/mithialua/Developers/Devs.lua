...
function Player.staff(player, str, int)
	local loreTable = {charIDs = {4, 165}, charLevels = {5, 1}}
	local mapTable = {charIDs = {5, 391, 1395, 1437, 1512}, charLevels = {3, 3, 3, 3, 3}}
	local scriptTable = {charIDs = {5, 1395, 1437, 1829}, charLevels = {5, 3, 3, 5}}
	local projectManagerTable = {charIDs = {1, 2}, charLevels = {1, 1}}
	local accessLevel = -1
