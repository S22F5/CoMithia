housing179732 = {
	click = async(function(player,npc)
		...
		if(player.mapRegistry["house179732setting"]==0) then
		...
		if(player.registry["house179732owner"]==1) then
			local choice=player:menuString2("What do you wish to do?",opts)
				if(choice=="Enter house" and player.registry["house179732owner"]==1) then
					player:warp(10001,14,28)
				elseif(choice=="Relinquish Ownership" and player.registry["house179732owner"]==1) then
							...
							if(#check>0) then
								for z=1,#check do
									if(string.lower(check[z].name)==string.lower(name)) then
										...
										housing179732.ownercheck(Player(name),npc)
									end
								end
							end
						end
							...
							if(#check>0) then
								for z=1,#check do
									if(string.lower(check[z].name)==string.lower(name)) then
										...
										housing179732.sellcheck(Player(name),npc)
									end
								end
							end
						end
				...
				elseif(choice=="Invite guest" and player.registry["house179732owner"]==1) then
							...
							if(#check>0) then
								for z=1,#check do
									if(string.lower(check[z].name)==string.lower(name)) then
										...
										housing179732.guestcheck(Player(name),npc)
									end
								end
							end
						end
				...
				elseif(choice=="Remove guest access" and player.registry["house179732owner"]==1) then
					...
					if(string.lower(name)~=string.lower(player.name)) then
						if(Player(name).registry["house179732guest"]==1) then
						Player(name).registry["house179732guest"]=0
						...
						if(Player(name).m==10001) then
							Player(name):warp(17,97,33)
						end
						end
					else
		...
		elseif(player.registry["house179732guest"]==1 or player.mapRegistry["house179732setting"]==1) then
				player:warp(10001,14,28)
		else
			player:warp(17,97,33)
							...
							if(#check>0) then
								for z=1,#check do
									if(string.lower(check[z].name)==string.lower(Player(player.registry["popuphouseownership"]).name)) then
										check[z].registry["house179732owner"]=0
										check[z].registry["house179732guest"]=0
										player.registry["house179732owner"]=1
										player.registry["house179732guest"]=0
							...
							if(#check>0) then
								for z=1,#check do
									if(string.lower(check[z].name)==string.lower(Player(player.registry["popuphouseguest"]).name)) then
										player.registry["house179732guest"]=1
