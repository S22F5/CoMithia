		...
		l=2000000000/x
			...
			if(#f>0) then
				...
				if(f[1].name=="Perendale sheep") then
					player:sendMinitext("Your shears are not good enough to shear a Perendale sheep.")
				end
				if(f[1].name=="Shetland sheep") then
					player:sendMinitext("Your shears are not good enough to shear a Shetland sheep.")
				end
