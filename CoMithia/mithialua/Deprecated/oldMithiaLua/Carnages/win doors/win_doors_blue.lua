	...
	open=function(player)
		if(player.side==0) then
    	        	if(player.registry["carnagehost"]>0) then		
                		local obj=getObject(2100,19,32)
				if(obj==340) then
					setObject(2100,19,32,360)
					setObject(2100,20,32,361)
					player:sendMinitext("Opened.")
					return
				elseif(obj==360) then
					setObject(2100,19,32,340)
					setObject(2100,20,32,341)
...
hid21002033 = {
	open=function(player)
		if(player.side==0) then
    	        	if(player.registry["carnagehost"]>0) then		
                		local obj=getObject(2100,20,32)
				if(obj==341) then
					setObject(2100,19,32,360)
					setObject(2100,20,32,361)
					player:sendMinitext("Opened.")
