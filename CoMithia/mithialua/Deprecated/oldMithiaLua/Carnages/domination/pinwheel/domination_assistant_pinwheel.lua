domination_assistant_pinwheel1 = {
		...
		local t={graphic=convertGraphic(6,"monster"),color=15}
	        local opts = { }
				...
				elseif(menuOption=="Force ending") then
					...
					player.mapRegistry["dominationroundstart"]=0
					return
...
domination_assistant_pinwheel2 = {
	click = async(function(player,npc)
		local f=0
		local g=0
		local t={graphic=convertGraphic(6,"monster"),color=15}
...
domination_assistant_pinwheel3 = {
	click = async(function(player,npc)
		local f=0
		local g=0
		local t={graphic=convertGraphic(6,"monster"),color=15}
...
domination_assistant_pinwheel4 = {
	click = async(function(player,npc)
		local f=0
		local g=0
		local t={graphic=convertGraphic(6,"monster"),color=15}
...
domination_assistant_pinwheel5 = {
	click = async(function(player,npc)
		local f=0
		local g=0
		local t={graphic=convertGraphic(6,"monster"),color=15}
