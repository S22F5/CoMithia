tara = {
	click = async(function(player,npc)
		local t={graphic=convertGraphic(11,"monster"),color=5}
	        local opts = { }
			      ...
			      player.npcColor=t.color
                              ...
                              if(#opts~=0) then
                                  ...
                                  elseif(menuOption=="Safety tokens") then
                                     player:dialogSeq({t,"Hello!\n\nEvery day I see people appearing by magic in my Tavern!",t,"I once asked a fellow traveller and he said he was using a Safety token to get transported directly in one of Uruzgard's inns.",t,"If you ask me, this is powerful magic. Someone who's more accurate than myself with magical arts could probably tell you more about these."})
                                  end
                               end
        end)
}